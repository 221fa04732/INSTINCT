                ...
                <AccordionItem value={index.toString()} key={index}>
                    <AccordionTrigger className="hover:no-underline">
                        <div className={`flex flex-col md:flex-row gap-6`}>
                            <img src={item.image} className="max-h-20 md:max-h-32 max-w-20 md:max-w-32 rounded-4xl"/>
                            <div className="flex flex-col items-start justify-center">
                                ...
                                <div className="flex justify-center items-end gap-2">
                                    <a href={item.linkedinURL} target="_blank"><img src="./linkedin_blue.png" className="max-h-5 max-w-5" /></a>
                                    <a href={item.twitterURL} target="_blank"><img src="./twitter_blue.png" className="max-h-5 max-w-5" /></a>
                                </div>
                            </div>
                        </div>
                    </AccordionTrigger>
